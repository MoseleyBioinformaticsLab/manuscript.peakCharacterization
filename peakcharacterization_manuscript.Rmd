...
There are two issues with these peak intensities across scans: 1 - Some peak intensities correlate with the scan; 2 - Some peak differences across scans are correlated with intensity.
...
The highlighted peaks in Figure XB are those with an intensity greater than 0.7, and at least visually, their differences are **not** correlated with intensity.
...
loadd(correlate_scan_height_plot_correlate_scan_height_data)
