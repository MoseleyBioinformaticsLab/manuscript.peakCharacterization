...
As an example, in `r figure_count$label_text("motivation")`, we show the Xcalibur calculated intensities from the simplistically averaged spectrum and theoretical peak intensities based on NAP for four peaks matching threonine.
...
The narrowing of the distribution is detected in the change of the standard deviations (SD) of the RSDs.
...
Of the starting 181 samples, nine did not finish during scan-centric characterization for various reasons.
