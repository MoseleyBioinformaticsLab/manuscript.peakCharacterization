...
`r figure_count$label_text("nap_intensity")` compares the peak-peak isotopic natural abundance probability and height log-ratio differences (Equation X in Methods) generated using heights from Xcalibur and from our scan-level peak characterization.
:::
...
`r format_equation('frequency = intercept + x* \\frac{1}{\\sqrt{mz}} + y * \\frac{1}{\\sqrt[3]{mz}}', 'mzfrequency')`
:::
