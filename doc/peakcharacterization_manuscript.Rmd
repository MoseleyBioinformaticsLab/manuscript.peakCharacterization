...
SMIRFE in particular uses expected relationships of relative peak height or intensity to natural abundance probability (NAP) across multiple peaks to determine the likelihood of an assignment for the peaks in question.
...
::: {custom-style="MDPI_3.1_text"}
To motivate our solution, we generated peak lists using the peak exporting functionality in Xcalibur (a process we have observed being used to generate datasets), as well as merging scans (see Methods) with the MSnbase R package.
