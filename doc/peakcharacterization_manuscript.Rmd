...
As an example, in `r figure_count$label_text("motivation")`, we show the Xcalibur calculated intensities and theoretical peak intensities based on NAP for four peaks assigned to threonine.
As the NAP decreases, the deviations of the Xcalibur calculated intensities from the NAP become larger.
:::
...
The Thermo-Fisher Fusion instrument from which most of our collaborators data has been acquired, at a resolution of 450K or 500K depending on the sample, has a mode of 0.5, as shown in `r figure_count$label_text("mz_frequency_conversion")`C, D and E.
...
Restricting to those points that fall into a narrow range around the mode of frequency differences (0.49 - 0.51 in this work), a model of frequency to m/z can be generated (see Methods), with an example shown in `r figure_count$label_text("mz_frequency_conversion")`F.
