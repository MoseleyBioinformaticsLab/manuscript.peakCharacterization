...
The difference divided by the midpoint is used to derive the frequency values in **B**.
**B** plots the intensity vs the converted frequency points derived from **A**.
The red lines denote the differenc between adjacent points, which are shown in the y-axis of **C** for this single peak.
