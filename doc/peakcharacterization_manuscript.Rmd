...
It is clear that the raw scan-level intensities are superior.
:::
...
However, scan-level peak characterization requires a sophisticated pipeline of QC/QA and processing steps to derive a superior characterization with informative statistics and QC/QA metrics.
