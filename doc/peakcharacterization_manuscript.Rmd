...
We created potential EMF databases for SMIRFE assignments for ECF and 15N labeled amino acids or for lipids (see supplemental materials for the actual limits).
We assigned ECF derivatized amino acid samples with 15N labeling, a single positive charge, and H and Na as adducts.
We assigned lipid samples with no labeling, a single positive charge, and H, Na, K, and NH4 as possible adducts.
