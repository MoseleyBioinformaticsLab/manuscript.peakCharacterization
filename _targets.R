...
lungcancer_tar = list(
  ...
  tar_target(scancentric_json,
             "data/data_output/lung_data/lung_json_data_2022-05-11.rds",
             format = "file"),
  tar_target(scancentric_med_file_corrected,
             "data/data_output/lung_data/corrected_medians_2022-05-11.rds",
             format = "file"),
  ...
  tar_target(emf_file,
             "data/data_output/lung_data/lung_voted_all_2022-05-11.rds",
             format = "file"),
